...
class INTERNAL:
    def connect(id):
        LOCAL_ADINFO = usocket.getaddrinfo(
            ...
            FIREBASE_GLOBAL_VAR.GLOBAL_URL_ADINFO["port"],
            0,
            usocket.SOCK_STREAM,
        )[0]
        ...
        if FIREBASE_GLOBAL_VAR.GLOBAL_URL_ADINFO["proto"] == "https:":
            try:
                FIREBASE_GLOBAL_VAR.SLIST["SS" + id] = ussl.wrap_socket(
                    FIREBASE_GLOBAL_VAR.SLIST["S" + id],
                    server_hostname=FIREBASE_GLOBAL_VAR.GLOBAL_URL_ADINFO["host"],
                )
            except:
                print(
    ...
    def get(PATH, DUMP, id, cb, limit):
        ...
        LOCAL_SS = FIREBASE_GLOBAL_VAR.SLIST["SS" + id]
        LOCAL_SS.write(
            b"GET /" + PATH + b".json?shallow=" + ujson.dumps(limit) + b" HTTP/1.0\r\n"
        )
        LOCAL_SS.write(
            b"Host: " + FIREBASE_GLOBAL_VAR.GLOBAL_URL_ADINFO["host"] + b"\r\n\r\n"
        )
